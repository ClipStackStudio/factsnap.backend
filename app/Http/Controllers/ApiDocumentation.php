 ...
 * )
 * @OA\Schema(
 *     schema="PushTokenInfo",
 *     @OA\Property(property="push_token", type="string", description="Push notification device token", nullable=true),
 *     @OA\Property(property="platform", type="string", enum={"ios", "android", "web"}, description="Device platform", nullable=true),
 *     @OA\Property(property="is_token_active", type="boolean", description="Whether the token is active"),
 *     @OA\Property(property="token_registered_at", type="string", format="date-time", description="When the token was registered", nullable=true)
 * )
 * @OA\Schema(
 *     schema="PushTokenRegistration",
